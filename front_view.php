...
<div class="" style="
 ...
 ">
	<div class="row">
		<div class="col-sm-12" style="padding:0;"><div id="" class="owl-carousel owl-theme">'; ?>
	  ...
	  <?php $return_v .='
		<p>
								 ...
								 <?php if($client['reply'] !='' AND $client['reply'] !=null){ ?> <?php $return_v .='<span data-toggle="popover" data-placement="top" title="Reply from expert" data-content="'.$client['reply'].'" style="cursor:pointer;font-size:13px;" >1 <i class="fa fa-fw fa-comments"></i> <a>Click to Read Experts Reply</a><span>'; ?> <?php } ?>
								 <?php $return_v .='</p>
										</div>
									</div>
								</div>
